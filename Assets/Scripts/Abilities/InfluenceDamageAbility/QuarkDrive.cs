...
public class QuarkDrive : BaseAbility
{
    public override bool ShouldTrigger(ETimePoint TimePoint, Event SourceEvent)
    {
        ...
        if(TimePoint != ETimePoint.PokemonIn && TimePoint != ETimePoint.BattleStart && TimePoint != ETimePoint.AfterMegaEvolution && TimePoint != ETimePoint.AfterChangeTerrain)
        {
            return false;
        }
        ...
        if(SourceEvent.GetEventType() == EventType.TerrainChange)
        {
            TerrainChangeEvent CastedEvent = (TerrainChangeEvent)SourceEvent;
            return CastedEvent.GetNewTerrain() == EBattleFieldTerrain.Electric;
        }
        return false;
    }
    ...
    public override List<Event> Trigger(BattleManager InManager, Event SourceEvent)
    {
        ...
        if(InManager.GetTerrainType() == EBattleFieldTerrain.Electric)
        {
