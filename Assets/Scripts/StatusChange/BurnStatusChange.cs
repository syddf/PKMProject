...
public class BurnStatusChange : BaseStatusChange
{
    public BurnStatusChange(BattlePokemon InReferencePokemon) : base(InReferencePokemon)
    {
    ...
    public override List<Event> Trigger(BattleManager InManager, Event SourceEvent)
    {
        ...
        DamageEvent damageEvent = new DamageEvent(ReferencePokemon, selfDamage, "烧伤效果");
        NewEvents.Add(new StatusChangeAnimationFakeEvent(ReferencePokemon, EStatusChange.Burn));
